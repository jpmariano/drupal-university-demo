...
<div id="page" class="page-default <?php if(isset($nucleus_skin_classes)) print $nucleus_skin_classes?>">
  <a name="Top" id="Top"></a>
    ...
    <div class="container <?php print $grid; ?>">
      <div class="grid-inner clearfix">
        <div id="header" class="clearfix">
          ...
          <!-- One Page Menu -->
          <?php if(isset($onepage_menu)) print $onepage_menu?>
          <!-- /#One Page Menu -->          
  ...
  <?php if ($page_introduction = render($page['page_introduction'])): ?>
    <?php print $page_introduction; ?>
  <?php endif; ?>
    
  <?php if ($page_portfolio = render($page['page_portfolio'])): ?>
    <?php print $page_portfolio; ?>
  <?php endif; ?>
    
  <?php if ($page_team = render($page['page_team'])): ?>
    <?php print $page_team; ?>
  <?php endif; ?>
    
  <?php if ($page_client = render($page['page_client'])): ?>
    <?php print $page_client; ?>
  <?php endif; ?>
    
  <?php if ($page_contact = render($page['page_contact'])): ?>
    <?php print $page_contact; ?>
  <?php endif; ?>
