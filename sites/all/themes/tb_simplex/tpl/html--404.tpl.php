    ...
    <div id="page"  class="page-404">
      <div id="outline">
        <div id="errorboxoutline">
          <h1>404</h1>
          <div class="page-404-message"><?php print t('Something went wrong! The page you are looking for is not available')?></div>
          <div id="errorboxbody">
            <?php print t('Go <a title="@title" href="@url">Home</a> or try a search:',array(
              '@url' => base_path(),
