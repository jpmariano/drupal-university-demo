      ...
      <div class="grid-inner clearfix">
        <div id="header" class="clearfix">
          ...
          <div id="menu-bar-wrapper">				
            <a title="Navigation Icon" href="javascript:void(0);" class="tb-main-menu-button responsive-menu-button" style="display:none"></a>
            <?php print $menu_bar; ?>			  
          </div>
          <!-- /#MAIN NAV -->
          <?php endif; ?>
...
<?php if ($panel_multiple): ?>
	<!-- PANEL MULTIPLE -->
	<div id="panel-multiple-wrapper" class="wrapper panel panel-multiple">
		<div class="container <?php print $grid ?> clearfix" >
			<?php print $panel_multiple ?>
		</div>
	</div>
	<!-- #PANEL MULTIPLE -->
<?php endif; ?>     
