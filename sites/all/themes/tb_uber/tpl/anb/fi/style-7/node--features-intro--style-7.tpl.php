  ...
  <div class="container">
    ...
    <div class="row">          
      ...
      <?php foreach ($features as $delta => $item) : ?>
        ...
        <div class="features-item <?php echo (($delta+1)%2==1) ? 'col-sm-6 col-md-3 odd' : 'col-sm-6 col-md-3 col-md-offset-6';?>">
