...
<div id="page" class="page-default <?php print isset($page['nucleus_skin_classes']) ? $page['nucleus_skin_classes'] : ""; ?>">
			...
			<div class="header-container">
			  <div class="grid-inner clearfix">
				<div id="header" class="clearfix">
                 <div class="grid-1 empty-box">
				 	</div>
				  <?php if ($logo): ?>
					<a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" id="logo" class="grid-3">
				  ...
				  <?php if($menu_bar = render($page['menu_bar'])): ?>
					<!-- MAIN NAV -->
					<div id="menu-bar-wrapper" class="wrapper fs-large grid-18">			    
							<div class="grid-inner clearfix">
								  <?php print $menu_bar; ?>
							</div>			    
					</div>
				 ...
				 <div id="header-bottom" class="grid-24 clearfix">
					 ...
					 <?php if ($header_social_links = render($page['header_social_links'])):?>
						<?php print $header_social_links; ?>
					 <?php endif; ?>
         ...
         <?php if($landing_header = render($page['landing_header'])): ?>
    	 	<!-- PAGE LANDING -->
		<div class="page-landing-header"> 
			<div class="<?php print $grid; ?> clearfix">
				<?php print $landing_header; ?>
			</div>
		</div>
		<?php endif; ?>
           <!-- /#PAGE LANDINGT -->
           
		  <?php if($alert = render($page['alert'])): ?>
		  	<!-- ALERT -->
				<div class="alert"> 
					<div class="<?php print $grid; ?> clearfix">
						<?php print $alert; ?>
		...
		<?php endif; ?>
		  ...
		  <?php if ($is_front): ?>
			  ...
			  <?php endif; ?>	
		  <?php endif; ?>	
		   <?php if(!drupal_is_front_page()) : ?> <!-- Remove main-wrapper from Front page -->
		  ...
		  <div id="panel-fourth-wrapper" class="wrapper panel panel-fourth">
			<div class="container <?php print $panel_fourth_cols;?> <?php print $grid;?> clearfix"><div id="panel-fourth-inner"> <?php print $panel_fourth;?> <div class="clearfix"></div></div> </div>
		  ...
		  <?php endif; ?>
		   <?php if($back_to_top_display): ?>
				<a title="<?php print t('Back to Top')?>" class="btn-btt" href="#Top"><i class="fa fa-arrow-circle-up"></i></a>
	     <?php endif; ?>		
</div>
