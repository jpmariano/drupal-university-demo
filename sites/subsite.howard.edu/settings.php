...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_adminunits_dev_subsite_howard_edu.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_adminunits_dev_subsite_howard_edu.inc';
}
// </DDSETTINGS>

if (file_exists('/var/www/site-php')) {
    require('/var/www/site-php/adminunits/subsite_howard_edu-settings.inc');
}